# --- path shim (DGM-H entry scripts under scripts/dgmh/) ---
...
def main():
    ...
    parser.add_argument('--model', required=False, default=model_registry.resolve("task_agent").model, help='LLM model to use')
